...
public class MoveBehaviour : GenericBehaviour
{
	...
	void MovementManagement(float horizontal, float vertical)
	{
		...
		{
			float forceMultiplier = 100f; // À ajuster selon le gameplay
			behaviourManager.GetRigidBody.AddForce(direction * speed * forceMultiplier, ForceMode.Acceleration);
		}
	...
	/// <summary>
	/// Réinitialise les vitesses quand elles changent dynamiquement
	/// </summary>
	public void RefreshSpeedSeeker()
	{
		speedSeeker = runSpeed;
		Debug.Log($"[MoveBehaviour] SpeedSeeker réinitialisé à {speedSeeker}");
		Debug.Log($"[MoveBehaviour] walkSpeed={walkSpeed}, runSpeed={runSpeed}, sprintSpeed={sprintSpeed}");
	}
}
